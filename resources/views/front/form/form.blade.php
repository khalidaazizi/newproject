   ...
   <section class="row">
        <div class="col-6 offset-3">
            ...
            <form action="{{route('form.store')}} " method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="passwor_confirmation" class="form-label">تکرار رمز عبور</label>
                    <input type="password" class="form-control border " name="password_confirmation" id="passwor_confirmation" placeholder="رمز عبور تان را تکرار کنید" required>
                </div>
